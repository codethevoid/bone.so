...
const btnVariants = cva(
  "inline-flex items-center justify-center rounded-lg cursor-pointer font-medium ease outline-none gap-1.5 focus:ring-3 ring-primary/15 dark:ring-primary/20 transition-all disabled:opacity-60 disabled:pointer-events-none ease",
  {
    variants: {
      variant: {
        primary:
        ...
        outline:
          "border text-foreground hover:border-primary/20 focus:border-primary/50",
